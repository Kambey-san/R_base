...
# Определение статистик для оценки интервала
...
Для тестирования гипотезы воспользуемся функцией z.test() из пакета "BSDA". Выбираем критерий Z, поскольку он более предпочтителен при неизвестном стандартном отклонении
"""
